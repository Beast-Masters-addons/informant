...
--[[
	This section is for loading Informant Options Access Methods
...
function miniIcon.Reposition(angle)
	if not Informant.Settings.GetSetting("miniicon.enable", true) then
		miniIcon:Hide()
		return
	end
	miniIcon:Show()
...
-- finally a trigger function for our methods
